...
public class AESUtil {
     ...
     */
    private static String sKey = "NBx1fA67b5"; //UJ6QCKALDB73PNQJ
    private static String ivParameter = "9193085203915907";
    ...
    // 解密
    public static String decryptByRandom(String sSrc, String random) throws Exception {
        try {
            byte[] raw = (sKey+random).getBytes("ASCII");
            SecretKeySpec skeySpec = new SecretKeySpec(raw, "AES");
            Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
            IvParameterSpec iv = new IvParameterSpec(ivParameter.getBytes());
            cipher.init(Cipher.DECRYPT_MODE, skeySpec, iv);
