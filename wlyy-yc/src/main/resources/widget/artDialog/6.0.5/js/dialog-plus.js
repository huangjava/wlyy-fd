...
$.extend(Popup.prototype, {
    ...
    __center: function () {
		...
		/*if(this.__browser.versions.ios){
			...
			style.marginTop = '-'+(popup.outerHeight(true)/2)+'px';
		}*/
    },
...
artDialog.create = function (options) {
    ...
    this.addEventListener('show', function () {
		$backdrop.css({opacity: options.backdropOpacity,background: options.backdropBackground});
        /*$backdrop.css({ 小米4 APP壳不能有动画过程
            opacity: 0,
