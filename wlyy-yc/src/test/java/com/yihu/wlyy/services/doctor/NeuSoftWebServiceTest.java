...
public class NeuSoftWebServiceTest {
    ...
    //2c9660e34f4fbb9d014f5d5453b8001b   联棚卫生院
    //b825206f-6af4-4009-b9bc-7a9c71f820d5   糖尿病团队
    //f93afa56-417c-4901-aeab-002ded330d86    家庭医生
    ...
    public void doSignApply() throws Exception {
        String info = neuSoftWebService.doSignApply("林霖","17112345678","2016-09-08","123","Dummy007","b825206f-6af4-4009-b9bc-7a9c71f820d5");
        System.out.println(info);
    }
